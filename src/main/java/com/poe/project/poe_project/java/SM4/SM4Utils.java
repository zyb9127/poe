...
public class SM4Utils {
    ...
    public static void main(String[] args) {
        System.out.println("经过ECB加密的密文为：" + SM4Utils.encryptData_ECB("test中文"));
        System.out.println("经过ECB解密的密文为：" + SM4Utils.decryptData_ECB("UQZqWWcVSu7MIrMzWRD/wA=="));
        //System.out.println("经过CBC加密的密文为：" + SM4Utils.encryptData_CBC("poe", "1234567890123456", "1234567890123456"));
        //System.out.println("经过CBC解密的密文为：" + SM4Utils.decryptData_CBC("gIg9odK49/WXK39AbOoXlA==", "1234567890123456", "1234567890123456"));
    }
}
